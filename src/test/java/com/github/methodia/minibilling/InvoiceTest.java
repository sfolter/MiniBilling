...
public class InvoiceTest {
    ...
    public void getInvoice() {
        ...
        final List<Integer> linesForTaxes = new ArrayList<>();
        linesForTaxes.add(1);
        ...
        taxesLines.add(new Taxes(1, linesForTaxes, "Standing charge", 69, "days", new BigDecimal("1.6"), new BigDecimal("56")));
        final Invoice invoice = new Invoice(LocalDateTime.of(2022, 8, 30, 10, 53, 32), "10001", user.getName(),
                new BigDecimal("511"),
        ...
        Assertions.assertEquals("Ivan", invoice.getConsumer(), "User does not match");
        ...
        Assertions.assertEquals(1, invoice.getLines().size(), "Lines does not match");
