...
public class MainTest {
    ...
    private void testSample(final int sampleNumber, final String yearMonth) throws IOException, ParseException, JSONException {
    ...
    private void checkDirectories(final File sampleDir, final File outputDir, final int sampleNumber) throws IOException, JSONException {
    ...
    private void assertInvoiceJsonFilesEqual(final File sampleJson, final File outputJson, final int sampleNumber) throws IOException, JSONException {
    ...
    private void assertPropertiesEqual(final JSONObject sampleJsonObject, final JSONObject outputJsonObject, final String key,
                                       final int sampleNumber) throws JSONException {
    ...
    private String getSampleInputDir(final int sampleNumber) {
    ...
    private String getOutputDir(final int sampleNumber) {
    ...
    private String getExpectedDir(final int sampleNumber) {
        final URL inputDir = MainTest.class.getClassLoader()
